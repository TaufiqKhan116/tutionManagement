...
public class SignUpStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(event->
        {
            ...
            {
                Toast.makeText(SignUpStudent.this, "One or more fields are empty", Toast.LENGTH_SHORT).show();
                return;
            }
            RequestQueue queue = Volley.newRequestQueue(this);
            String url = "http://192.168.43.166:3000/signUpStudent?name=" + name.getText().toString() + "&pass=" + pass.getText().toString()
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,(response)->{
                Toast.makeText(SignUpStudent.this, "Profile added", Toast.LENGTH_SHORT).show();
            }, error -> {
                Toast.makeText(SignUpStudent.this, error.toString(), Toast.LENGTH_SHORT).show();
            });
